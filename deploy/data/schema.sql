...
CREATE SEQUENCE "public"."actives_id_seq" INCREMENT 1 START 558 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
-- ----------------------------
ALTER SEQUENCE "public"."actives_id_seq" RESTART 559 OWNED BY "instruments"."id";
